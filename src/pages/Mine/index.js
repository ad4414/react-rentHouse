...
const Mine=()=>{
    ...
    <div style={{ display:'flex',justifyContent:'center' }}>
         ...
         <Avatar src={png2} style={{ '--size': '90px','--border-radius':'50%',textAlign:'center'}}/>
    </div>
    <List header='个人信息列表'>
        ...
        <List.Item prefix={<LocationOutline />} extra='河南省...' onClick={() => {}}>
          家庭住址
        </List.Item>
        <List.Item prefix={<FolderOutline />} extra='北京市...' onClick={() => {}}>
          我的收藏
        </List.Item>
        <List.Item prefix={<SetOutline />} onClick={()=>{}}>
            设置
        </List.Item>
         <List.Item style={{display:'flex',justifyContent:'center',color:'red'}} onClick={async () => {
